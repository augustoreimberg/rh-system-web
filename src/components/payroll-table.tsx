                ...
                <Table>
                  ...
                  <TableBody>
                    {group.employees.map((employee) => {
                      ...
                      const hasPayroll =
                        payroll !== null && payroll !== undefined;
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            {hasPayroll ? payroll.quantityDayWork : "-"}
                          </TableCell>
                          <TableCell>
                            {hasPayroll ? (
                              <div>
                          ...
                          <TableCell>
                            {hasPayroll
                              ? formatCurrency(payroll.foodVoucher)
                              : "-"}
                          </TableCell>
                          <TableCell>
                            {hasPayroll
                          ...
                          <TableCell className="font-semibold">
                            {hasPayroll
                              ? formatCurrency(payroll.totalPayable)
                              : "-"}
                          </TableCell>
                          <TableCell>
                            {hasPayroll ? formatDate(payroll.paymentDate) : "-"}
                          </TableCell>
                          <TableCell>
                            {hasPayroll && payroll.paidAt ? (
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={(e) =>
                                  handleMarkAsPaidClick(employee, e)
                                }
                              ...
                              {hasPayroll ? (
                                <>
                                  ...
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={(e) =>
                                      handleDownloadReceipt(employee, e)
                                    }
                                  >
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="font-semibold">
                            {formatCurrency(
                              selectedEmployee.payrolls[0].totalPayable
                            )}
                          </p>
                        </div>
                        <div>
                          ...
                          <p>
                            {formatDate(
                              selectedEmployee.payrolls[0].paymentDate
                            )}
                          </p>
                        </div>
                      </div>
      ...
      {selectedEmployee &&
        ...
        selectedEmployee.payrolls.length > 0 && (
          <MarkAsPaidModal
            ...
            payrollDocumentId={selectedEmployee.payrolls[0].documentId}
