...
export function EditPayrollForm({ employee, payroll, onSuccess, month, year }: EditPayrollFormProps) {
  const [isSubmitting, setIsSubmitting] = useState(false)
  const [error, setError] = useState<string | null>(null)

  // Parse the dates if they exist
  const paymentDate = payroll.paymentDate ? parseISO(payroll.paymentDate) : null
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      setError("Ocorreu um erro ao atualizar a folha de pagamento. Tente novamente.")
    } finally {
