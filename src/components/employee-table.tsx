...
import { getEmployees, deleteEmployee, type Employee } from "@/actions/employee-actions"
...
export function EmployeeTable() {
  ...
  return (
    <div className="space-y-4">
      ...
      <EmployeeModal open={modalOpen} onClose={handleModalClose} employee={editingEmployee} />
    </div>
  )
}
